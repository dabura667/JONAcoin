...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "JONAcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"JONAcointools.com", "dnsseed.JONAcointools.com"},
    {"JONAcoinpool.org", "dnsseed.JONAcoinpool.org"},
    {"xurious.com", "dnsseed.JONA.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"JONAcointools.com", "testnet-seed.JONAcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. JONAcoin is probably already running."), addrBind.ToString().c_str());
        else
