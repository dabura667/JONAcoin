...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/jonacoin-qt.exe
    File /oname=COPYING.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/jonacoind.exe
    ...
    Delete /REBOOTOK $INSTDIR\jonacoin.exe
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\jonacoin-qt.exe
